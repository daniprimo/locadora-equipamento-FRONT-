...
import BotaoDevolucao from '../buttos/botaoDevolucao';
  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }} style={{marginBottom: 2, backgroundColor: '#dcedc8'}}>
        ...
        <TableCell align="center">{row.dataRetirada}</TableCell>
        <TableCell align="center">{row.horaRetirada}</TableCell>
        <TableCell align="center">{row.quantidadeItens}</TableCell>
        <TableCell>
            <BotaoDevolucao id={row.id} />
        </TableCell>
      </TableRow>
      <TableRow>
...
export default function ListaDeRetirados(props) {
  return (
